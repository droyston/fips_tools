...
%% 1: REALIGN
matlabbatch{1}.spm.spatial.realign.estwrite.data = {tempfile}';% <--- VARIABLE from above
...
matlabbatch{6}.spm.spatial.coreg.estimate.source = {[MRI_Info_current.T1_file ',1']}; % <-- VARIABLE
