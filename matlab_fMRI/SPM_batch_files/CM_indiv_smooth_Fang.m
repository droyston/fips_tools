...
% 
% === UPDATES ===
% 2016-07 Fang Liu modified the script
% 	
%
% === TO DO ===
%
...
load('Master_Processing_Parameter_Fang.mat'); % Loads MRI_Info_current
...
%% 3: fMRI Model Specification
matlabbatch{3}.spm.stats.fmri_spec.dir = {MRI_Info_current.output_path};
matlabbatch{3}.spm.stats.fmri_spec.timing.units = 'scans';
matlabbatch{3}.spm.stats.fmri_spec.timing.RT = MRI_Info_current.ExpDef_TR;
...
%% 6: Coregistration: Fang selected the different coregistration method (2016-07) 
matlabbatch{6}.spm.spatial.coreg.estwrite.ref = {[MRI_Info_current.T1_file ',1']};
