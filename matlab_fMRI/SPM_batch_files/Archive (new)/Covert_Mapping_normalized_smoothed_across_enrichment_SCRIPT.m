...
%
% Batch job file created for Covert Mapping analysis
%
%
%
%
...
matlabbatch{2}.spm.spatial.coreg.estimate.source = {[MRI_Info_current.T1_file ',1']}; % <-- VARIABLE
...
switch num_conditions
    ...
    case 5
        ...
        matlabbatch{8}.spm.stats.con.consess{6}.fcon.name = 'Movement artifact';
        matlabbatch{8}.spm.stats.con.consess{6}.fcon.weights = [0 0 0 0 0 1 1 1];
        matlabbatch{8}.spm.stats.con.consess{6}.fcon.sessrep = 'none';
