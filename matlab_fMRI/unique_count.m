function [numUnique,uniques] = unique_count(x,option)
% Determines unique values, and counts occurrences
%   [numUnique,uniques] = unique_count(x,option);
%
...
% 2014-06-26 Foldes:    renamed from 'count_unique' so you can actually remember it
%                       switched output order (if you wanted uniques, just do unique.m)
